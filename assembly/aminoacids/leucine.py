...
def action1(space:Space):
    ...
    if space.t==800:
        space.compute2atoms()
        i2 = space.merge_from_file("examples/simple/CH2.json",x,30+y,-30+z)
        #space.appendatom(a1)
    ...
    if space.t==1600:
        space.compute2atoms()
        i3 = space.merge_from_file("examples/simple/methyl.json",40+x,-30+y,z)
        #space.appendatom(a1)
    ...
    if space.t==2000:
        space.compute2atoms()
        i4 = space.merge_from_file("examples/simple/methyl.json",30+x,30+y,z)
        #space.appendatom(a1)
