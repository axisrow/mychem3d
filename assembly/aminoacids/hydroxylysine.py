...
def action1(space:Space):
    ...
    if space.t==1900:
        space.compute2atoms()
        i5 = space.merge_from_file("examples/simple/CH2.json",60+x,60+y,z)
    ...
    if space.t==2300:
        space.compute2atoms()
        i6 = space.merge_from_file("examples/simple/aminogroup.json",80+x,y,z)
    ...
    if space.t==3200:
        ...
        i7 = space.merge_from_file("examples/simple/OH.json",80+x,y,z-20)
        space.atoms2compute()
